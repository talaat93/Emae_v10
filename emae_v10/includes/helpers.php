...
{
    return [
        'bg_from' => setting('hero_bg_from', '#04113b'),
        'bg_to' => setting('hero_bg_to', '#18357f'),
        'glow_left' => setting('hero_glow_left', '#4a233f'),
        'glow_right' => setting('hero_glow_right', '#335dff'),

        'eyebrow' => setting('home_eyebrow', 'EMAE - INTERVENTION RAPIDE 24H/24 7J/7'),
        'eyebrow_color' => setting('home_eyebrow_color', '#83a6ff'),

        'title' => setting('home_title', 'Dépannage et rénovation en électricité, climatisation, PAC, ventilation et chauffage'),
        'title_color' => setting('home_title_color', '#ffffff'),
        ...
        'lead_color' => setting('home_lead_color', '#dbe6ff'),
        ...
        'chips' => array_values(array_filter([
            setting('home_chip_1', 'Électricité'),
            setting('home_chip_2', 'Plomberie'),
            setting('home_chip_3', 'CVC'),
            setting('home_chip_4', 'Climatisation'),
            setting('home_chip_5', 'Chauffage'),
            setting('home_chip_6', 'PAC'),
